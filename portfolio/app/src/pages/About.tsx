        ...
        <div className="mb-20">
          ...
          <div className="expertise-grid grid grid-cols-1 md:grid-cols-2 gap-6">
            {cards.map((card, index) => (
              <div
                key={index}
                className="expertise-card group relative bg-white/[0.02] border border-white/10 p-8 hover:bg-white hover:text-black transition-all duration-500 overflow-hidden"
              >
...
export default function About() {
  const config = {
    aboutParagraph:
      "A visionary technologist at the intersection of artificial intelligence and human-centered design. I architect digital ecosystems that don't just function—they evolve. Specializing in AI-driven automation, scalable cloud infrastructure, and immersive user experiences, I transform complex challenges into elegant solutions. My mission is to empower businesses with intelligent systems that anticipate needs, automate workflows, and deliver measurable impact.",
    cards: [
      {
        number: "01",
        icon: (
        ...
        description:
          "Designing and deploying custom LLM solutions, neural networks, and machine learning pipelines that bring autonomous intelligence to your product stack.",
      },
      {
        number: "02",
        icon: (
        ...
        description:
          "Building production-grade applications with Next.js, React, Node.js, and modern cloud architecture. From MVP to enterprise-scale systems.",
      },
      {
        number: "03",
        icon: (
        ...
        description:
          "Crafting pixel-perfect interfaces backed by research, accessibility standards, and conversion-focused interaction design. Beauty meets function.",
      },
      {
        number: "04",
        icon: (
        ...
        description:
          "Speed, security, and scalability are non-negotiable. I build systems optimized for performance, from server-side rendering to edge computing.",
      },
    ],
    imageSrc: profilePic,
