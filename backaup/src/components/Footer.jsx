export default function footer() {
    return (
        <>
            <style>{`
                @import url('https://fonts.googleapis.com/css2?family=Macondo&family=Micro+5&family=Orbitron:wght@400..900&family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&family=Shadows+Into+Light+Two&display=swap');
            
                * {
                    font-family: Orbitron, Micro 5,'Poppins', sans-serif;
                }
            `}</style>
            
            <footer className="flex flex-col items-center justify-center w-full py-20 bg-gradient-to-b from-[#57b6e6] to-[#021e3d] text-white/70">
                ...
                <p className="mt-4 text-center">Copyright © 2025 <a href="https://prebuiltui.com">Akshat Kushnoor</a>. All rights reservered.</p>
