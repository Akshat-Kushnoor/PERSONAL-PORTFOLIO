...
const Home = () => {
  ...
  const socials = [
    {
      name: "GitHub",
      href: "https://github.com/Akshat-Kushnoor",
      icon: (
    ...
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/in/akshat-kushnoor-0b8484212/",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        >
          ...
          >
            <div className="px-4 py-3 bg-white/[0.03] backdrop-blur-md border border-white/5 rounded-lg">
              ...
              <p className="text-lg text-white font-light">2+ Years</p>
            </div>
          </motion.div>
          ...
          >
            <div className="px-4 py-3 bg-white/[0.03] backdrop-blur-md border border-white/5 rounded-lg">
              ...
              <p className="text-lg text-white font-light">5+</p>
            </div>
          </motion.div>
        </motion.div>
      </div>
